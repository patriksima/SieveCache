...
public class OptimizedSieveCacheTests
{
    ...
    {
        var cache = new OptimizedSieveCache<int, int>(3);
    ...
    {
        var cache = new OptimizedSieveCache<int, int>(2);
    ...
    {
        var cache = new OptimizedSieveCache<string, string>(2);
        cache.Put("a", "Apple");
        cache.Put("b", "Banana");
    ...
    {
        var cache = new OptimizedSieveCache<int, string>(2);
    ...
    {
        var cache = new OptimizedSieveCache<int, int>(500);
